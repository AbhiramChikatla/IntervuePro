            ...
            <div className="max-w-[900px] mx-auto px-4">
                <div className="flex flex-col items-center text-center pb-44 py-16">
                    ...
                    <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
                        Prepare for any job interview with personalized AI
                        feedback, realistic mock interviews, and expert curated
                        questions tailored to your industry.
                    </p>
                    ...
                    <div className="mt-8 flex items-center justify-center gap-2">
                        ...
                        <p className="text-sm text-gray-500">
                            Trusted by{" "}
                            <span className="font-semibold">100+</span> job
                            seekers
                        </p>
                    </div>
                </div>
