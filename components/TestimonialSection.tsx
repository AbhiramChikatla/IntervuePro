  ...
  const testimonials = [
    {
      ...
      stars: 5,
      text: "IntervuePro prepared me thoroughly for the Product Manager role. The AI-driven feedback was so detailed that my responses became far more impactful and structured.",
    },
    {
      name: "Rohit Gupta",
    ...
    },
    {
      ...
      stars: 5,
      text: "I used to get nervous in interviews, but IntervuePro's realistic mock sessions completely changed my game. Practicing HR drills helped me express myself with clarity.",
    },
  ];
