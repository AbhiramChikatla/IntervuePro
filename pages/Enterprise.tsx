      ...
      <Card className="bg-white shadow-md border border-gray-200">
        <CardContent className="p-8">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-3xl font-bold mb-6 mt-5 text-gray-900">Intervuepro Enterprise</h1>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                <p><strong>IntervuePro Enterprise</strong> is a tailored solution for organizations and educational institutions to streamline mock interview training and hiring readiness. Designed for scalability and control, the Enterprise plan enables companies to manage candidate preparation, monitor interview performance, and integrate talent evaluation with organizational workflows.</p>
                <p>Whether you're a university placement cell, a bootcamp, or a large organization with in-house training, Intervuepro Enterprise ensures your users receive structured, AI-powered interview preparation customized to your needs.</p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-6 text-gray-700">
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>Enterprises can post jobs directly on the IntervuePro platform</li>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                <p>IntervuePro Enterprise aims to empower organizations to take control of career readiness and hiring preparation. With powerful tools, analytics, and customization, we help you bridge the gap between learning and employability — at scale.</p>
            ...
            <section>
              ...
              <div className="text-gray-700">
                ...
                <div className="mt-4 p-4 bg-gray-50 rounded-lg space-y-2">
                  <p><strong>General Support:</strong> hire.mentis.interview@gmail.com</p>
                  <div className="flex gap-4 mt-4">
                    <a
                      href="https://x.com/IntervuePro"
                      target="_blank"
                    ...
                    <a
                      href="https://www.linkedin.com/in/intervuepro/"
                      target="_blank"
                      className="text-gray-400 hover:text-emerald-500"
                    >
                      <svg
