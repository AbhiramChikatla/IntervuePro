      ...
      <Card className="bg-white shadow-md border border-gray-200">
        <CardContent className="p-8">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-3xl font-bold mb-6 mt-5 text-gray-900">IntervuePro Help Center</h1>
            <p className="text-sm text-gray-600 mb-8">Welcome to the IntervuePro Help Center! We're here to support you every step of the way. Below you'll find answers to common questions, guides, and resources to help you get the most out of our platform.</p>
              ...
              <div className="space-y-6 text-gray-700">
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>If it's still missing, contact us at <strong>hire.mentis.interview@gmail.com</strong></li>
                  </ul>
                </div>
