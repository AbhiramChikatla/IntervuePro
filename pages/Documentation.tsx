        ...
        <CardContent className="p-8">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-3xl font-bold mb-6 mt-5 text-gray-900">
              IntervuePro: AI Mock Interview Platform
            </h1>
            ...
            <div className="space-y-8">
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  <p>
                    <strong>IntervuePro</strong> is an AI-powered platform built
                    to help job seekers simulate real interview experiences.
                    Whether you are a fresh graduate or an experienced
                    professional, IntervuePro offers personalized mock
              ...
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  <p>
                    IntervuePro is committed to making interview preparation
              ...
              <section>
                ...
                <div className="text-gray-700">
                  <p>
                    For questions, feedback, or support regarding the IntervuePro
                    platform, please contact us at:
                  </p>
                  <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                  <p>
                    <strong>Email :</strong>
                    <span className="hover:text-emerald-500"> hire.mentis.interview@gmail.com</span>
                  </p>
